  ...
  return (
      <nav className=" w-full z-20  start-0  border-gray-200 relative">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <Link to="/">
              <LazyImage src={logo} className="w-24 min-[400px]:w-28" alt="Flowbite Logo"  loader={<div className="w-24 min-[400px]:w-28 h-[30px] min-[400px]:h-[35px]  bg-gray-100 animate-pulse" />}/>
          </Link>

          <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
              <Link to={'/signup'} type="button" className="text-main-color max-[500px]:hidden border-main-color  border bg-white hover:bg-gray-50 font-medium rounded-md  px-4 py-2 md:mr-3 text-center text-sm  trans">Sign up</Link>
              <Link to={'/login'} type="button" className="text-white bg-sec-color font-medium rounded-md  px-4 py-2 text-center text-sm hover:bg-main-color trans">Login</Link>
